...
var Lists7 = [ 
       ...
       document.getElementById("ddlSortField13"),
       document.getElementById("ddlSortField14")
	     
],
     nbLists7 = Lists7.length;


// Binds change events to each list
for(var iList7 = 0; iList7 < nbLists7; iList7++) {
     Lists7[iList7].onchange = RemoveItems7(iList7);
}


function RemoveItems7(iList7) {
     return function() {
          var value7 = [];

          // Add the selected items of all previous lists including the one changed
          for(var jList7 = 0; jList7 <= iList7; jList7++)              value7.push(Lists7[jList7].options[Lists7[jList7].selectedIndex].text);


          // Hide in all succeeding lists these items
          for(var kList7 = iList7 + 1; kList7 < nbLists7; kList7++)
               HideItems7(kList7, value7);
     }
}


// Hide items selected in previous lists in all next lists
function HideItems7(iList7, value7) {
     var nbOptions7 = Lists7[iList7].options.length,
         nbValues7 = value7.length,
         found;

     if(nbValues7 === 0) return;

     for(var iOption7 = 0; iOption7 < nbOptions7; iOption7++) {
          // Find if this element is present in the previous lists
          found = false;
          for(var iValue7 = 0; iValue7 < nbValues7; iValue7++) {
               if(Lists7[iList7].options[iOption7].text === value7[iValue7]) {
                    found = true;
                    break;
               }
          }
          ...
          // If found, we hide it
         if(found) {
               Lists7[iList7].options[iOption7].style.display = "none";
             Lists7[iList7].options[iOption7].selected = "";
         }
          // else we un-hide it (in case it was previously hidden)
          else 
               Lists7[iList7].options[iOption7].style.display = "";
     }
}
...
var Lists3 = [ 
     ...
     document.getElementById("ddlSortField12"),
...
/*
     // Enumerate CORE SEM 2
var Lists5 = [ 
     document.getElementById("ddlSortField20"), 
     document.getElementById("ddlSortField23"),
     document.getElementById("ddlSortField24")
